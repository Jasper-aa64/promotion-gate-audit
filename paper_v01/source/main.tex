...
a reproducible case study, and a preregistered design for a later authorization-
frontier study; it does not claim a universal false-promotion rate, a superior
gate, or cross-system generality.
\end{abstract}
...
The gate audited here is the same frozen \texttt{paired\_bootstrap\_permutation\_v1}
...
candidate model attribution or raw agent logs, so this report does not claim
